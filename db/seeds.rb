...
user1 = User.create!(username: 'robert', email: 'robert@gmail.com', password_digest: 'asdf', session_token: 'asdf')
user2 = User.create!(username: 'bill', email: 'bill@gmail.com', password_digest: 'asdffas', session_token: 'asdffas')
